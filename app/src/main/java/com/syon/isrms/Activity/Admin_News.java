...
public class Admin_News extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__news);
    ...
    private void init() {
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(Admin_News.this);
    ...
    private void doOperation() {
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Admin_News.super.onBackPressed();
            }
        });
        btn_select_classes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                set_classes.setText("");
                final Dialog dialog;
                dialog = new Dialog(Admin_News.this);
                    ...
                    call.enqueue(new Callback<AdminClassFillBean>() {
                        ...
                        public void onResponse(Call<AdminClassFillBean> call, Response<AdminClassFillBean> response) {
                            ...
                            if (response.code() == 200) {
                                ...
                                recyclerView.setLayoutManager(new GridLayoutManager(Admin_News.this, 3));
                                recyclerView.setAdapter(new Admin_News_Selction_Adapter(Admin_News.this, data));

                            } else {
                                Toast.makeText(Admin_News.this, "Data Not Found", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(Call<AdminClassFillBean> call, Throwable t) {
                            Toast.makeText(Admin_News.this, "Internet Connection Me be show or off", Toast.LENGTH_SHORT).show();
                    ...
                    call.enqueue(new Callback<AdminDepartmentFillBean>() {
                        ...
                        public void onResponse(Call<AdminDepartmentFillBean> call, Response<AdminDepartmentFillBean> response) {
                            ...
                            if (response.code() == 200) {
                                ...
                                recyclerView.setLayoutManager(new GridLayoutManager(Admin_News.this, 3));
                                recyclerView.setAdapter(new Admin_News_Department_Selction_Adapter(Admin_News.this, data));
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Admin_News.this, "please select date", Toast.LENGTH_SHORT).show();
                }
                else if (set_classes.getText().equals("select class") && set_departments.getText().equals("select department"))
                {
                    Toast.makeText(Admin_News.this, "please select class or department", Toast.LENGTH_SHORT).show();
                }

                else if (set_title.getText().length()<=0)
                {
                    Toast.makeText(Admin_News.this, "please fill title", Toast.LENGTH_SHORT).show();
                }
                else if (set_description.getText().length()<=0)
                {
                    Toast.makeText(Admin_News.this, "please fill description", Toast.LENGTH_SHORT).show();
                }
        ...
        btn_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             startActivity(new Intent(Admin_News.this,Admin_News_View.class));
        ...
        set_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(Admin_News.this, date, calendar
        ...
        select_upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Admin_News.this, FilePickerActivity.class);
    ...
    private void uploadFile() {
        ...
        try {
            postMultipart.run(url,"NewsEvents",file);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    private void postDepartmentNews() {
        ...
        try {
            OkHttpClient.Builder builder = new OkHttpClient.Builder();
            apiInterfce = com.syon.isrms.Interfaces_Teacher.ApiClient.getApiClient(builder).create(ApiInterfce.class);
            Call<AdminNewsBean> call = apiInterfce.postNewsEvents(preferences.getString(getString(R.string.adminEmpIdNo), ""),date,title,description,filename,preferences.getString(getString(R.string.adminEmpIdNo),""),"1",class_id,department_id,"2",preferences.getString(getString(R.string.adminSessionIdNo), ""), preferences.getString(getString(R.string.adminSchCode), ""));
            call.enqueue(new Callback<AdminNewsBean>() {
                @Override
                public void onResponse(Call<AdminNewsBean> call, Response<AdminNewsBean> response) {

                    if (response.code()==200) {

                        Toast.makeText(Admin_News.this, response.body().getData().toString(), Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Admin_News.this, "News not published", Toast.LENGTH_SHORT).show();

                    }
                }

                @Override
                public void onFailure(Call<AdminNewsBean> call, Throwable t) {
            ...
            Toast.makeText(Admin_News.this, "something went wrong try again after sometime", Toast.LENGTH_SHORT).show();
        }

    }

    private void postClassNotification() {
        final String title=set_title.getText().toString();
        ...
        try {
            OkHttpClient.Builder builder = new OkHttpClient.Builder();
            apiInterfce = com.syon.isrms.Interfaces_Teacher.ApiClient.getApiClient(builder).create(ApiInterfce.class);
            Call<AdminNewsNotificationBean> call = apiInterfce.postAdminNewsNotification(class_id,title,"2",title,preferences.getString(getString(R.string.School_Name),""),preferences.getString(getString(R.string.adminEmpIdNo),""),preferences.getString(getString(R.string.adminSessionIdNo), ""), preferences.getString(getString(R.string.adminSchCode), ""));
    ...
    private void postDeptNotification() {
        ...
        try {
            OkHttpClient.Builder builder = new OkHttpClient.Builder();
            apiInterfce = com.syon.isrms.Interfaces_Teacher.ApiClient.getApiClient(builder).create(ApiInterfce.class);
            Call<AdminNewsNotificationBean> call = apiInterfce.postAdminNewsNotificationDept(department_id,title,"2","News",preferences.getString(getString(R.string.School_Name),""),preferences.getString(getString(R.string.adminEmpIdNo),""),preferences.getString(getString(R.string.adminSessionIdNo), ""), preferences.getString(getString(R.string.adminSchCode), ""));
            call.enqueue(new Callback<AdminNewsNotificationBean>() {
                @Override
                public void onResponse(Call<AdminNewsNotificationBean> call, Response<AdminNewsNotificationBean> response) {

                    if (response.code()==200) {
                        Toast.makeText(Admin_News.this, "pass", Toast.LENGTH_SHORT).show();

                    } else {

                        Log.e("error:",department_id+" "+title+" "+2+" "+"News"+" "+preferences.getString(getString(R.string.School_Name),"")+" "+preferences.getString(getString(R.string.adminEmpIdNo),"")+" "+preferences.getString(getString(R.string.adminSessionIdNo), "")+" "+ preferences.getString(getString(R.string.adminSchCode), ""));
                    }
                }
    ...
    private void postClassNews() {
        ...
        try {
            OkHttpClient.Builder builder = new OkHttpClient.Builder();
            apiInterfce = com.syon.isrms.Interfaces_Teacher.ApiClient.getApiClient(builder).create(ApiInterfce.class);
            Call<AdminNewsBean> call = apiInterfce.postNewsEvents(preferences.getString(getString(R.string.adminEmpIdNo), ""),date,title,description,filename,preferences.getString(getString(R.string.adminEmpIdNo),""),"1",class_id,department_id,"1",preferences.getString(getString(R.string.adminSessionIdNo), ""), preferences.getString(getString(R.string.adminSchCode), ""));
            call.enqueue(new Callback<AdminNewsBean>() {
                @Override
                public void onResponse(Call<AdminNewsBean> call, Response<AdminNewsBean> response) {
