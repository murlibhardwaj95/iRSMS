...
public class Exam_Result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrefs = PreferenceManager.getDefaultSharedPreferences(Exam_Result.this);
       ...
       /* LayoutInflater mInflater = LayoutInflater.from(this);
        ...
        drower.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Exam_Result.super.onBackPressed();
            }
        });
        TextView logoicon=(TextView)mCustomView.findViewById(R.id.logoicon);
        logoicon.setText("Exam Result");
        logoicon.setCompoundDrawablesWithIntrinsicBounds(R.drawable.exre, 0, 0, 0);
*/
    ...
    private void FessDataaa(final String lUPIdNo, final String lSessionId, final String sSchCode) {
        final ProgressDialog pd = new ProgressDialog(Exam_Result.this);
        pd.setMessage("Loading...");
        pd.setCancelable(false);
        pd.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiClient.BASE_URL+"ExamResult",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            webView.setVisibility(View.GONE);
                            datanotfound.setVisibility(View.VISIBLE);
                           /* MyToast.show(Exam_Result.this,"Server Data Error Try Again !!!",false);*/
                        }
                        pd.dismiss();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        webView.setVisibility(View.GONE);
                        datanotfound.setVisibility(View.VISIBLE);
                       /* MyToast.show(Exam_Result.this, "Connection Time Out Error Try Again !!",false);*/
                    }
                }){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Exam_Result.this);
...
// TODO Auto-generated method stub
            prDialog = ProgressDialog.show(Exam_Result.this, null, "Loading...");
