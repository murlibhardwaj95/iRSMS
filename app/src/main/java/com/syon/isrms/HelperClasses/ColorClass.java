...
public class ColorClass {
    ...
    public static final int[] COLORFUL_COLORS = {
            Color.rgb(64, 89, 128),Color.rgb(193, 37, 82), Color.rgb(255, 102, 0), Color.rgb(245, 199, 0),Color.rgb(255, 247, 140),
            Color.rgb(191, 134, 134),Color.rgb(106, 150, 31),  Color.rgb(192, 255, 140),Color.rgb(217, 184, 162),Color.rgb(255, 208, 140)
    };
    public static final int[] VORDIPLOM_COLORS = {
            Color.rgb(192, 255, 140), Color.rgb(255, 247, 140), Color.rgb(255, 208, 140),
            Color.rgb(140, 234, 255), Color.rgb(255, 140, 157)
    };
    public static final int[] NEW_COLOR1 = {
            Color.rgb(58 , 145, 39)
    };
    public static final int[] NEW_COLOR2 ={
            Color.rgb(186, 44, 44)
    };
    /**
