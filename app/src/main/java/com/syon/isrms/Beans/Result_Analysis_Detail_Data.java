...
public class Result_Analysis_Detail_Data implements Serializable
{
    ...
    public Float getDStudCntPercent() {
        return dStudCntPercent;
    }

    public void setDStudCntPercent(Float dStudCntPercent) {
