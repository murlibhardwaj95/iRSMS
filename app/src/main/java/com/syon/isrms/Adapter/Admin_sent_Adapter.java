...
public class Admin_sent_Adapter extends RecyclerView.Adapter<Admin_sent_Adapter.Viewholder> {
    Context conte;
    List<SentBox_Bean_Data> list;
    ProgressDialog progressDialog;

    //List<Userbean_ParentInbox_data> list;
    public Admin_sent_Adapter(Context conte,  List<SentBox_Bean_Data> list) {
        this.conte = conte;
      this.list=list;
        //this.list = list;
    }
    ...
    public void onBindViewHolder(Viewholder holder, final int position) {
        ...
        holder.frominbox.setText(list.get(position).getToUser());
