...
public class Admin_Adapter_Circualar_View extends RecyclerView.Adapter<Admin_Adapter_Circualar_View.ViewHolder> {
    List<Admin_Circualar_View_Bean_Data> data;
    Context context;
    ProgressDialog progressDialog;

    public Admin_Adapter_Circualar_View(Context context,  List<Admin_Circualar_View_Bean_Data> data) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.dateneews.setText(data.get(position).getSCirDate().toString());
