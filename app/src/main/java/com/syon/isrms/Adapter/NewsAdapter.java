...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    List<Userbean_News_Data> data;
    Context context;
    ProgressDialog progressDialog;

    public NewsAdapter(Context context, List<Userbean_News_Data> data) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        if (holder.discriptionnews.length() > 58) {
            holder.viewnews.setVisibility(View.VISIBLE);
            holder.readmore.setVisibility(View.VISIBLE);
        } else {
            holder.readmore.setVisibility(View.GONE);
            holder.viewnews.setVisibility(View.GONE);
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            headingnews = itemView.findViewById(R.id.heading);
            dateneews = itemView.findViewById(R.id.date);
            discriptionnews = itemView.findViewById(R.id.des);
            readmore = itemView.findViewById(R.id.readmorenews);
            download = itemView.findViewById(R.id.removetocart);
            viewnews = itemView.findViewById(R.id.viewnewss);
        }
    }
    ...
    public class DownloadNewsFile extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setTitle("News / Events");
