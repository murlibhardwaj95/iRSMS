...
public class ResultAnalysis_Recycle_Adapter extends RecyclerView.Adapter<ResultAnalysis_Recycle_Adapter.ViewHolder> {
    List<Result_Analasis_Data> data;
    String exam_id;
    Context context;

    public ResultAnalysis_Recycle_Adapter(Context context, List<Result_Analasis_Data> data,String exam_id) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.result_analysis_layout, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.btnViewDetailes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                v.getContext().startActivity(new Intent(context, com.syon.isrms.Activity.Teacher_Result_Analysis_Detail.class).putExtra("exam_id",exam_id).putExtra("tbl_id",data.get(position).getTblId().toString()));
            }
        });
