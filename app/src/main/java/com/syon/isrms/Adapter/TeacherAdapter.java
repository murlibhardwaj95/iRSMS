...
public class TeacherAdapter extends RecyclerView.Adapter<TeacherAdapter.ViewHolder> {
    ...
    public TeacherAdapter(Context context, List<Userbean_TeacherData> data) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        /* holder.teachercheck.setOnCheckedChangeListener(null);*/
        /* holder.teachercheck.setTag(position);*/
        holder.teachercheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                /*else if (!holder.teachercheck.isChecked()) {
