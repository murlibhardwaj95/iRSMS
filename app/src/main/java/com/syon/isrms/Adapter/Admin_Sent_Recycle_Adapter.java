...
public class Admin_Sent_Recycle_Adapter extends RecyclerView.Adapter<Admin_Sent_Recycle_Adapter.ViewHolder> {
    List<SentBox_Bean_Data> data;
    Context context;
    ProgressDialog progressDialog;

    public Admin_Sent_Recycle_Adapter(Context context, List<SentBox_Bean_Data> data) {
