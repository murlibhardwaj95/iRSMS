...
public class InboxAdapter_parent extends RecyclerView.Adapter<InboxAdapter_parent.Viewholder> {
    Context conte;
    ProgressDialog progressDialog;
    List<Userbean_ParentInbox_data> list;
    public InboxAdapter_parent(Context conte,List<Userbean_ParentInbox_data> list) {
    this.conte = conte;
    this.list = list;
    }
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(View itemView) {
            super(itemView);
            subjectin = itemView.findViewById(R.id.setSubjectparent);
            messagein = itemView.findViewById(R.id.setDescriptionparent);
            frominbox = itemView.findViewById(R.id.setfrom);
            datein = itemView.findViewById(R.id.setDate);
            attachementin = itemView.findViewById(R.id.setAttechmentparentparent);
            detailinbox = itemView.findViewById(R.id.btn_detailparent);
