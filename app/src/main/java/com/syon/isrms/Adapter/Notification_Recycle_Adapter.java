...
import com.syon.isrms.Beans.Usebean_Notification_Data;
import com.syon.isrms.R;

import java.util.List;

public class Notification_Recycle_Adapter extends RecyclerView.Adapter<Notification_Recycle_Adapter.ViewHolder> {
    List<Usebean_Notification_Data> data;
    Context context;

    public Notification_Recycle_Adapter(Context context, List<Usebean_Notification_Data> data) {
