...
public class Inbox_Recycle_Adapter extends RecyclerView.Adapter<Inbox_Recycle_Adapter.ViewHolder> {
    List<Inbox_Bean_Data> data;
    Context context;
    ProgressDialog progressDialog;

    public Inbox_Recycle_Adapter(Context context, List<Inbox_Bean_Data> data) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.lblfrom.setText("From: "+data.get(position).getFromUser().toString());
                ...
                builder.setMessage("Do you want to download the attachment?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                new outboxStudentDowmload().execute(data.get(position).getSAttachment());
        ...
        holder.detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                heading.setText(data.get(position).getFromUser());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            lblfrom=itemView.findViewById(R.id.lblType);


        }
    }
    public class outboxStudentDowmload extends AsyncTask<String, Integer, String> {
