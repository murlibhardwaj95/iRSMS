...
public class Admin_Notice_Board_Adapter extends RecyclerView.Adapter<Admin_Notice_Board_Adapter.ViewHolder> {

    Context ctx;
    List<Bean_Admin_Discussion_Board_Two> discus;

    public Admin_Notice_Board_Adapter(Context ctx,List<Bean_Admin_Discussion_Board_Two> discus) {
        this.ctx = ctx;
        this.discus = discus;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.meassage_layout,parent,false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            photo = itemView.findViewById(R.id.circle);
            namesendr = itemView.findViewById(R.id.name);
            discuss_date = itemView.findViewById(R.id.discuss_date);
            datetime = itemView.findViewById(R.id.datetimea);
            messagetxt = itemView.findViewById(R.id.message_body);
